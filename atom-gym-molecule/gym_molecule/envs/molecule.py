...
from get_homo import get_homo_of_a_COF
...
def reward_target_mof(final_mol):
    ...
    command = ["/home/bachelor/zhangjinhang/molRL/zeo++-0.3/molecule_to_abstract","/home/bachelor/zhangjinhang/molRL/GCPNs/envs/atom-gym-molecule/gym_molecule/dataset/myby.xyz","0","/home/bachelor/zhangjinhang/molRL/GCPNs/envs/atom-gym-molecule/gym_molecule/dataset/myby_1.xyz"]
    res = subprocess.run(command)
    if res.returncode != 0:
        return -1
    command = ["/home/bachelor/zhangjinhang/molRL/zeo++-0.3/framework_builder", "/home/bachelor/zhangjinhang/molRL/zeo++-0.3/nets/rhr.cgd", "1", "output", "/home/bachelor/zhangjinhang/molRL/zeo++-0.3/builder_examples/building_blocks/Cu2.xyz", "/home/bachelor/zhangjinhang/molRL/GCPNs/envs/atom-gym-molecule/gym_molecule/dataset/myby_1.xyz"]
    res = subprocess.run(command)
    if res.returncode != 0:
        return -1
    with torch.no_grad():
        ...
        model.load_state_dict(torch.load('save_homo_new5.pt',map_location=device))
        # 模型
        model.to(device)
        model.eval()
        return -get_homo_of_a_COF("output_framework.xyz",model,device)
